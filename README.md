# Available .WORLD One-Word Domains (9,419)
...
**Public extract:** 1,000 rows · **Live catalog:** 9,419 domains · **Median ask:** $9.50 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,419 live domains                         |
...
> Unique Domains. *Available .WORLD One-Word Domains*. Version 2026-05-11. Public GitHub extract for the exact Unique Domains search represented by this repository.
